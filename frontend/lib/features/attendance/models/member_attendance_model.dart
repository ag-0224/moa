...
///
/// openapi.yaml의 MemberAttendance 스키마와 매핑된다. 클릭 시 전공/학번/
...
class MemberAttendanceModel {
  ...
  factory MemberAttendanceModel.fromJson(Map<String, dynamic> json) {
    return MemberAttendanceModel(
      memberId: json['memberId'] as int,
      name: json['name'] as String,
      isMe: json['isMe'] as bool,
      todayMark: AttendanceMark.fromJson(json['todayMark'] as String),
      weeklyMarks: (json['weeklyMarks'] as List<dynamic>)
          .map((mark) => AttendanceMark.fromJson(mark as String))
          .toList(),
