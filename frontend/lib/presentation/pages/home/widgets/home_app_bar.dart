...
/// 최상단 바를 참고했다. 로고는 텍스트가 아니라 assets/logo_with_name.svg
/// (Figma 스펙 155x50)를 그대로 쓴다. 검색/알림 아이콘도 assets/icons/의
/// 실제 SVG(majesticons_search.svg, cil_bell.svg)를 쓴다. 별도 검색/알림
/// 화면은 아직 없어서 아이콘 탭은 onSearchTap/onNotificationTap 콜백으로
/// 밖에서 채워 넣도록 열어둔다.
