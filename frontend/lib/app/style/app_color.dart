...
class AppColor extends ThemeExtension<AppColor> {
  static final AppColor _light = AppColor._(
    ...
    brand3: const Color(0xFF4F46E5),
    brand4: const Color(0xFF3730A3),
    brand5: const Color(0xFFF7F8FC),
    gray1: const Color(0xFFF3F4F6),
    gray2: const Color(0xFFE5E7EB),
    gray3: const Color(0xFF9CA3AF),
    gray4: const Color(0xFF6B7280),
    gray5: const Color(0xFF4B5563),
    gray6: const Color(0xFF374151),
    gray7: const Color(0xFF111827),
    background1: const Color(0xFFF9FAFB),
    red1: const Color(0xFFFEE2E2),
    red2: const Color(0xFFEF4444),
    red3: const Color(0xFFDC2626),
    blue1: const Color(0xFFEFF6FF),
    blue2: const Color(0xFF3B82F6),
    blue3: const Color(0xFF2563EB),
    green1: const Color(0xFFD1FAE5),
    green2: const Color(0xFF10B981),
    green3: const Color(0xFF059669),
  );
